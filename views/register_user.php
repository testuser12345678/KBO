...
$ks = $k -> getAllAsArray();
foreach($ks as $ks) {
    $ks_selection[]=$ks['name'];
}

$klasse_selection_name = 'klasse_input_reg[]';
$klasse_name = array('klasse_input_reg[]');
$klasse_selection = $ks_selection;

$klasse_selection_output=selection($klasse_name,$klasse_selection,$klasse_selection_name);


//Klassenselection ende

//Erstellung des Arrays für die Tage
$tage=array();
for($i=1; $i<=31; $i++) {
    $tage[]=$i;
}

//Erstellung des Arrays für die Monate
$monate=array();
for($i=1; $i<=12; $i++) {
    $monate[]=$i;
}

//Erstellung des Arrays für die Jahre
$jahre=array();
for( $i=1900; $i<=2010; $i++) {
    $jahre[]=$i;
}
...
<table border="1" style="border-collapse:collapse;">
    <tr>
        ...
        <td><select name="typ_input_reg"><option>Sch&uuml;ler</option>
