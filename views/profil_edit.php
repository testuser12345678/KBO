...
<body>
	...
	<table border="0" height="350" width="500">
		...
		<!-- 7.Tabellenreihe Unter�bschreift f�r den about me-teil-->
		<tr height="25">
		...
		<!-- 9.Tabellenreihe f�r die Passwort�nderung-->
		<tr height="25">
			<td colspan="4" align="center"><h3>Passwort &auml;ndern</h3></td>
		</tr>
		<!-- 10.Tabellenreihe f�r die altes Passwort-->
		<tr height="25">
			<td colspan="2" align="right">altes Passwort:</td>
			<td><input type="password" value=""></td>
		</tr>
		<!-- 11.Tabellenreihe f�r die neues Passwort-->
		<tr height="25">
		...
		<!-- 13.Tabellenreihe "�bernehmen" und "abbrechen" Button-->
	</table>
